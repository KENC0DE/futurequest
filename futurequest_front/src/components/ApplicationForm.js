  ...
  const initializeFormData = () => {
    ...
    if (offerDetails.require_educational_background) {
      formData.educational_background = {
        high_school_name:
          studentData.educational_background?.high_school_name || "",
        high_school_address:
          studentData.educational_background?.high_school_address || "",
        high_school_graduation_date:
          studentData.educational_background?.high_school_graduation_date || "",
        high_school_gpa:
          studentData.educational_background?.high_school_gpa || "",
        high_school_major_subjects:
          studentData.educational_background?.high_school_major_subjects || "",
        high_school_honors_awards:
          studentData.educational_background?.high_school_honors_awards || "",
        undergraduate_university_name:
          studentData.educational_background?.undergraduate_university_name ||
          "",
        undergraduate_university_address:
          studentData.educational_background
            ?.undergraduate_university_address || "",
        undergraduate_graduation_date:
          studentData.educational_background?.undergraduate_graduation_date ||
          "",
        undergraduate_degree_awarded:
          studentData.educational_background?.undergraduate_degree_awarded ||
          "",
        undergraduate_gpa:
          studentData.educational_background?.undergraduate_gpa || "",
        undergraduate_major_subjects:
          studentData.educational_background?.undergraduate_major_subjects ||
          "",
        undergraduate_honors_awards:
          studentData.educational_background?.undergraduate_honors_awards || "",
      };
    }
    ...
    if (offerDetails.require_personal_statements) {
      formData.personal_statements = {
        background_influences:
          studentData.personal_statements?.background_influences || "",
        academic_interests:
          studentData.personal_statements?.academic_interests || "",
        career_goals: studentData.personal_statements?.career_goals || "",
        extracurricular_activities:
          studentData.personal_statements?.extracurricular_activities || "",
        personal_achievements:
          studentData.personal_statements?.personal_achievements || "",
        challenges_overcoming:
          studentData.personal_statements?.challenges_overcoming || "",
        unique_qualities:
          studentData.personal_statements?.unique_qualities || "",
        additional_information:
          studentData.personal_statements?.additional_information || "",
      };
    }
    ...
    if (offerDetails.require_documents) {
      formData.documents = {
        ...
        highschool_transcript:
          studentData.documents?.highschool_transcript || null,
        highschool_diploma: studentData.documents?.highschool_diploma || null,
        national_exam_result:
          studentData.documents?.national_exam_result || null,
        university_transcripts:
          studentData.documents?.university_transcripts || null,
