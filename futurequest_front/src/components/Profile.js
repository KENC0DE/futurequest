...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        ...
        const savedApplicationId = localStorage.getItem(
  ...
  if (applications.length === 0) {
    return (
      <div className="dark:text-white text-center h-screen">
  ...
  return (
    <div className="h-full relative">
      <div className="flex flex-col lg:flex-row justify-center p-4 bg-gray-200 dark:bg-slate-900 min-h-screen">
