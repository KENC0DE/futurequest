...
now include the functionality whe just added to this readme file
...
### 5. PATCH
Partially update an existing application form.
...
**Description:**
Partially updates an existing application form with the provided data. Only the fields included in the request body will be updated.
...
- **POST** `api/applications/` - Create a new application form.
- **PUT** `api/applications/<id>/` - Update an existing application form.
- **PATCH** `api/applications/<id>/` - Partially update an existing application form.
- **DELETE** `api/applications/<id>/` - Delete an existing application form.
- **Filtered Queries** - Use query parameters to filter the list of application forms.
